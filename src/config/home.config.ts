  ...
  hero: {
    ...
    subtitle: 'Pococí, Costa Rica',
    description:
      'Construyendo puentes hacia una comunidad más unida, pacífica y próspera. Trabajamos juntos por el desarrollo social y la convivencia armoniosa en Pococí.',
    image:
